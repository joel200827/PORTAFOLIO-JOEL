...
function validarformulario(e) {
    ...
    alert('hemos recibidos su datos, pronto nos ppondremos en contacto')

    console.log(`el nombre es :${nombre.value} su apellido es: ${Telefono.value} ${Email.value} ${Mensaje.value}`)
}
